...
# Load counts data (genes as rows and samples as columns)
counts_data <- read.csv('counts_data.csv', row.names = 1)

# Load metadata (sample information, e.g., conditions like Knockdown/Control)
...
# Generate PCA data
pca_data <- plotPCA(vsd, intgroup = "Knockdown", returnData = TRUE)  # Adjust 'Knockdown' to your specific condition
